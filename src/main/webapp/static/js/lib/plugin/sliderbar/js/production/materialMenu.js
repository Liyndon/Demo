...
(function( window ) {
  ...
  function Menu() {
    ...
    this.toggleFlag = document.querySelector("#panel-close-flag");
    this.menu = document.querySelector("#mm-menu");
    this.menuItems = this.menu.querySelectorAll("li");
    this.menuItemLinks = this.menu.querySelectorAll(".mm-menu__items a");
  ...
  Menu.prototype._initToggleEvents = function() {
    ...
    this.toggleFlag.addEventListener( "click", function() {
    	(scope.menuPosition == "off") ? scope._toggleMenuOn() : scope._toggleMenuOff();
    });
  };
